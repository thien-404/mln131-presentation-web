...
export default function Quiz() {
  const [info, setInfo] = useState({ name: "", score: 0 });
    ...
    <div className="max-w-4xl mx-auto text-center">
      ...
      {!isStarted ? (
        ...
        >
          ...
          {[
            { id: 1, name: "Nguyễn Văn A", score: 14, total: quizData.length },
            { id: 2, name: "Trần Thị B", score: 12, total: quizData.length },
            { id: 3, name: "Lê Văn C", score: 10, total: quizData.length },
            { id: 4, name: info.name, score: score, total: quizData.length }, // người chơi hiện tại
          ].map((player, idx) => (
            <div
              key={player.id}
